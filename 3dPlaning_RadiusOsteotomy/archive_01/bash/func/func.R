...
#       string <-paste("![](workSpace/img/",sample1,"/",list1[["inputData"]][i],".png)")
...
#     if(sapply(output[i], is.factor)){
#       sample1 <- gsub(" ", "_", sample)
#       string <-paste("![](workSpace/img/",sample1,"/",list1[["outputData"]][i],".png)")
#       updated_string <- gsub(" ", "", string)
#       escribir (updated_string)
...
#   escribir("\n\n")
#   for (i in 1:length(colnames(output))) {
#     df_subset2 <- subset(output, output[,list1[["compairMain"]][compairMain]] == levels(df_subset2[,list1[["compairMain"]][compairMain]])[2])
#     
#     if(sapply(df_subset2[i], is.numeric)){
#       
